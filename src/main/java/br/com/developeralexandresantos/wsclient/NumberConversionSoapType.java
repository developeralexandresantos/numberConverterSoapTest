...
public interface NumberConversionSoapType {
    ...
    @RequestWrapper(localName = "NumberToWords", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "br.com.developeralexandresantos.wsclient.NumberToWords")
    @ResponseWrapper(localName = "NumberToWordsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "br.com.developeralexandresantos.wsclient.NumberToWordsResponse")
    ...
    @RequestWrapper(localName = "NumberToDollars", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "br.com.developeralexandresantos.wsclient.NumberToDollars")
    @ResponseWrapper(localName = "NumberToDollarsResponse", targetNamespace = "http://www.dataaccess.com/webservicesserver/", className = "br.com.developeralexandresantos.wsclient.NumberToDollarsResponse")
