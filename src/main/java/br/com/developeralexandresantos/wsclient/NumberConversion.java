 ...
 * 2021-10-20T01:31:44.902-03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "NumberConversion",
                  wsdlLocation = "file:/home/alexandre/Documentos/Projetos/Servlets/HelloServlet/weatherSoap/src/main/resources/wsdl/NumberToWords.wsdl",
...
public class NumberConversion extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/alexandre/Documentos/Projetos/Servlets/HelloServlet/weatherSoap/src/main/resources/wsdl/NumberToWords.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(NumberConversion.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/home/alexandre/Documentos/Projetos/Servlets/HelloServlet/weatherSoap/src/main/resources/wsdl/NumberToWords.wsdl");
        }
        WSDL_LOCATION = url;
    }
